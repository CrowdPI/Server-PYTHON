...
# CREATE > subrouter
v1_products_blueprint = Blueprint('products', __name__)

# ROUTES > Products
@v1_products_blueprint.route('/products', methods=["GET"])
def get_products():
...
@v1_products_blueprint.route('/products/<product_id>', methods=['GET'])
...
# @v1_products_blueprint.route('/products/<product_id>/upload-img', methods=['POST'])
